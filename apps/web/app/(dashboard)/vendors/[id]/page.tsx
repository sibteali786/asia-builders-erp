        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p
                className={`text-base font-bold ${p.outstanding > 0 ? "text-[#C9A84C]" : "text-foreground"}`}
              >
                {fmt(p.outstanding)}
              </p>
            </div>
...
function PaymentHistoryTab({ vendorId }: { vendorId: number }) {
  ...
  return (
    <div className="space-y-3">
      {/* Table header */}
      <div className="grid grid-cols-[1fr_auto_auto_auto] gap-4 px-4 text-[10px] uppercase tracking-wide text-muted-foreground font-semibold">
      ...
      {rows.map((t) => (
        <div
          key={t.id}
          className="grid grid-cols-[1fr_auto_auto_auto] gap-4 items-center bg-white rounded-xl border border-border px-4 py-3.5"
        >
          {/* Arrow icon + description */}
          <div className="flex items-center gap-3 min-w-0">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-red-50 text-red-500 shrink-0">
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-border p-5">
          <div className="flex items-center gap-2 text-[10px] uppercase tracking-wide text-muted-foreground font-semibold mb-3">
        ...
        <div className="bg-white rounded-xl border border-border p-5">
          ...
          <p
            className={`text-3xl font-bold mt-2 ${vendor.outstanding > 0 ? "text-[#C9A84C]" : "text-foreground"}`}
          >
